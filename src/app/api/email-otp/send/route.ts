...
export async function POST(request: Request) {
  try {
    ...
    const subject = purpose === "registration" ? "RaktJaal email verification OTP" : "RaktJaal account deletion OTP";
    const heading = purpose === "registration" ? "Verify your RaktJaal account" : "Confirm RaktJaal account deletion";
